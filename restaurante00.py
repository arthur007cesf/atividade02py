...
carro1 = Carro('Monza', 'vermelho', 1972)
print(carro1)
...
cliente1 = Cliente('Joaquim Silva', 'joaquim@example.com', '4321-5678', 'Rua A, 100')
cliente2 = Cliente('Joao Henrique', 'joao@example.com', '8765-4321', 'Rua B, 200')
cliente3 = Cliente('Carlos Eduardo', 'carlos@example.com', '1122-3344', 'Rua C, 300')
